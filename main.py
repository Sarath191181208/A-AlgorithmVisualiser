...
WIN = pygame.display.set_mode((700, 601))
...
def PYtxt(txt: str, fontSize: int = 12, font: str =pygame.font.match_font('arial', bold=False, italic=False), fontColour: tuple = (0, 0, 0)):
...
def showtext():
    text = PYtxt("  Left to Insert", 11)
    txtHeight = text.get_height()
    WIN.blit(text, (board.width+10, 480))
    text = PYtxt('  Right to Delete',11)
    WIN.blit(text,(board.width+10,510))
